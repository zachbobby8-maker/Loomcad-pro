// Polyfill for standalone hosting outside Miniapps platform
if (typeof window.miniappI18n === 'undefined') {
  const fallbackTranslations = {
    "app.title": "LOOM-CAD PRO",
    "app.status_default": "LATTICE-LOCK: SECURE | RESONANCE: 39,420 Hz",
    "app.status_mission": "MISSION: {id} | RESONANCE: 39,420 Hz | LAMINAR: ON",
    "app.placeholder": "Enter Weaver Intent (e.g., 'mission CAD-008', 'braid', 'anchor')...",
    "app.cost_label": "MINT ESTIMATE",
    "app.cost_unit": "$BRAID",
    "app.console_label": "WEAVER_INPUT // 5IR ENGINE",
    "app.system_ready": "System initialized. Waiting for Weaver intent...",
    "app.ghost_braid": "Ghost preview active. Legendrian Möbius pattern generated. Say 'anchor' to finalize.",
    "app.ghost_strengthen": "Simulation complete. Ghost preview: Lamina thickened. Say 'anchor' to finalize.",
    "app.anchor_success": "Surface Woven. {reward} $BRAID anchored.",
    "app.anchor_fail": "No active ghost geometry to anchor.",
    "app.unknown": "Intent unclear. Lattice-Lock engaged. Try 'mission CAD-008', 'braid', or 'strengthen'.",
    "app.mission_cad008": "Mission CAD-008 loaded. Mars Cydonia gravity applied. Anchor points ready. Weave with caution.",
    "app.mission_loading": "Initializing workspace for mission {id}...",
    "app.mission_materials": "Loaded Legendrian Materials: 6D_Graphene & Dirac_Fluid."
  };
